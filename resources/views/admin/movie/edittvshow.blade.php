...
<body>
    ...
    <div class="movie-form-container">
        ...
        <h1 class="form-title">Edit "{{ $movie->title }}"</h1>

        <form action="{{ route('updatetvshow', $movie->id) }}" method="POST">
            @csrf
            @method('PUT') 
            ...
            <div class="form-group">
                ...
                <textarea id="synopsis" name="synopsis" 
                          ...
                          placeholder="Enter movie synopsis">{{ old('synopsis', $movie->synopsis) }}</textarea>
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" id="awardname" name="awardname" 
                       class="form-input @error('awardname') is-invalid @enderror" 
                       placeholder="Enter movie title"  />
              ...
              <div class="form-group">
                ...
                <input type="date" id="awarddate" name="awarddate" 
                       class="form-input @error('awarddate') is-invalid @enderror" 
                       />
