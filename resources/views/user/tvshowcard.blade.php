...
<head>
    ...
    <style>
        ...
        /* =========================================================
         1. UPGRADED: "CINEMATIC" TRANSPARENT NAVBAR
        =========================================================
        */
        ...
        */
        ...
        .movies_card{
            ...
            gap: 30px;
            padding: 50px;
            /* NEW: This makes it a horizontal slider */
            overflow-x: auto;
            overflow-y: hidden;
...
>
                ...
                <div class="hero-button-group">
                    <a href="#" class="hero-button">
                     ...
                     <form action="{{ route('watchlistdelete', $movie->id) }}" method="POST" style="display:inline;">
                             @csrf
                             @method('DELETE')
                            <input type="hidden" name="tv_show_id" value="{{ $movie->id }}">
                            <button type="submit" style="background-color: #e60000;" class="hero-button-secondary">
          ...
          <div>
                <div class="type">
                     <div class="cast">
                           <h1 class="typeh1">Related Tv show</h1>
                     </div>
                        ...
                        <button id="scroll-left" class="scroll-btn left">
                           ...
                           <div class="movies_card">
                              @foreach ($samecastmovies as $mo)
                                 <a href="{{ route('tvshowcardcard',$mo->id) }}">
                                      <div class="movie-card">
                                           
                                      <img src="https://th-i.thgim.com/public/incoming/wmujms/article70092693.ece/alternates/LANDSCAPE_1200/HBD_OG_LOCK%20copy.jpg" class="movie_img" alt="Movie Poster"/>
        ...
        <section class="review-section" id="review-form">
            <div class="review-form-card">
                 <form action="{{ route("posttvshowreviewreview") }}" method="POST">
                    @csrf
